...
def send_order_confirmation(new_order, template='shop/email/order_complete.txt'):
...
def send_order_notice(new_order, template='shop/email/order_placed_notice.txt'):
