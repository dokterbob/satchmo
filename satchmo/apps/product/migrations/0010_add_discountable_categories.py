...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field valid_categories on 'Discount'
        ...
        db.create_unique('product_discount_valid_categories', ['discount_id', 'category_id'])


    def backwards(self, orm):

        # Removing M2M table for field valid_categories on 'Discount'
