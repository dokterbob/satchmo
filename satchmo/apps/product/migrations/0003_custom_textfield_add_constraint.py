...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [slug, products] on CustomTextField.
        db.create_unique('product_customtextfield', ['slug', 'products_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [slug, products] on CustomTextField.
        db.delete_unique('product_customtextfield', ['slug', 'products_id'])
