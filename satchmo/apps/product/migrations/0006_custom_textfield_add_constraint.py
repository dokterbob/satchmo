...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttributeOption.error_message'
        db.alter_column('product_attributeoption', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Adding unique constraint on 'CustomTextField', fields ['products', 'slug']
        db.create_unique('product_customtextfield', ['products_id', 'slug'])


    def backwards(self, orm):

        # Changing field 'AttributeOption.error_message'
        db.alter_column('product_attributeoption', 'error_message', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Removing unique constraint on 'CustomTextField', fields ['products', 'slug']
        db.delete_unique('product_customtextfield', ['products_id', 'slug'])
