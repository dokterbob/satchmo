...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('product_attributeoption', 'error_message', self.gf('django.db.models.fields.CharField')(default=u'Invalid Entry', max_length=100))


    def backwards(self, orm):

        # Changing field 'AttributeOption.error_message'
        db.alter_column('product_attributeoption', 'error_message', self.gf('django.db.models.fields.CharField')(default=u'Inavlid Entry', max_length=100))
    ...
    models = {
        'product.attributeoption': {
            ...
            'error_message': ('django.db.models.fields.CharField', [], {'default': "u'Invalid Entry'", 'max_length': '1000'}),
