...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('product_attributeoption', (
            ('id', orm['product.attributeoption:id']),
            ('description', orm['product.attributeoption:description']),
            ('name', orm['product.attributeoption:name']),
            ('validation', orm['product.attributeoption:validation']),
            ('sort_order', orm['product.attributeoption:sort_order']),
            ('error_message', orm['product.attributeoption:error_message']),
        ))
        db.send_create_signal('product', ['AttributeOption'])
        
        # Adding field 'ProductAttribute.option'
        db.add_column('product_productattribute', 'option', orm['product.productattribute:option'])
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ProductAttribute.name'
        db.add_column('product_productattribute', 'name', orm['product.productattribute:name'])
